...
public class PassRegisterFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((PassWordActivity) getActivity()).setToolbarTitle(R.string.register_label);
        ...
        mRegisetAgreeTV = (TextView) view.findViewById(R.id.regiset_agree_text);
        mRegisetAgreeCb = (CheckBox) view.findViewById(R.id.regiset_agree_checkbox);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.regiset_agree_text:
                ToastUtils.showLong(getActivity(), "先同意注册协议才能注册");
                break;
            case R.id.regiset_sure_btn:
                if (checkSend()) {
                    HashMap<String, String> map = new HashMap<String, String>();
                    map.put("req", "UserResgistAccount");
                    map.put("usertype", "1");
                    map.put("phone", phone);
    ...
    private boolean checkSend() {
        ...
        if (!mRegisetAgreeCb.isChecked()) {
            ToastUtils.showLong(getActivity(), "请先勾选《注册协议》");
            return false;
        }
        return true;
    }
    ...
    private void CheckResult(String msg) {
        ...
        if(mResUser.getStateCode()!=600) {
            ...
            ToastUtils.showLong(getActivity(), "注册成功");
        }
    }
